...
export default async function CandidatePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <AppShell active="/candidates"><div className="content detail-content">
    ...
    <div className="detail-grid"><div className="detail-main">
      ...
      {parsed && <section className="card parsed-card"><div className="section-title"><h3>AI 解析结果</h3><span className="ai-label"><Icon name="spark" />{latestImport?.parser_version}</span></div>
